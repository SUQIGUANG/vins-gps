...
class IntegrationBase
{
  public:
    ...
    /**
     * @brief 通过中值积分实现IMU预积分，同时还计算了Jacobian
     * @param _dt
     * @param _acc_0
     * @param _gyr_0
     * @param _acc_1
                            ...
                            Eigen::Vector3d &result_linearized_ba, Eigen::Vector3d &result_linearized_bg, bool update_jacobian)
    {
        ...
        result_delta_p = delta_p + delta_v * _dt + 0.5 * un_acc * _dt * _dt;  /// 两帧间的 P
        result_delta_v = delta_v + un_acc * _dt;                              /// 两帧间的 V
    ...
    /**
     * @brief IMU状态传播，传播过程对IMU数据进行了中值预积分（唯一使用预积分的地方）
     * @param _dt
     * @param _acc_1
     * @param _gyr_1
     */
    ...
    /**
     * @brief 求解两帧间IMU的 P V Q Ba Bg 变化量之差，将其存在 15*1 的 residuals 中
     * @param Pi
     * @param Qi
     * @param Vi
     * @param Bai
